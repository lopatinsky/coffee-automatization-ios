...
@interface DBVenuesPopupContentController ()
...
- (void)viewDidLoad {
    ...
    self.venuesTableVC.mode = DBVenuesViewControllerModeChooseVenue;
    ...
    self.venuesMapVC.mode = DBVenuesViewControllerModeChooseVenue;
...
- (UIView *)db_popupContentRightNavigationItem {
    ...
    _rightNavButton.contentEdgeInsets = UIEdgeInsetsMake(3, 0, 0, 0);
    [_rightNavButton setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
    _rightNavButton.titleLabel.font = [UIFont fontWithName:@"HelveticaNeue-Light" size:14];
